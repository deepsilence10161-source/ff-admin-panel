...
var _modal_fa44_fa52_final_admin_tools = function _modal(title, html) {
  if (window.showAdminModal) showAdminModal(title, html);
  else if (window.showModal) showModal(title, html);
}
var _toast_fa44_fa52_final_admin_tools = function _toast(msg) { if (window.showToast) showToast(msg); }

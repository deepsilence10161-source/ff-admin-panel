...
--   guard_users_self_update abhi bhi 'win_streak' ko self-editable allow
--   karta tha — client apni streak khud inflate kar ke season-ranking score
--   (win_streak*10) badha sakta tha. Ab use allowed-list se nikal diya.
-- ═══════════════════════════════════════════════════════════════════════
BEGIN;

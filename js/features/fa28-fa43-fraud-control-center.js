...
var _modal_fa28_fa43_fraud_control_center = function _modal(title, html) {
  if (window.showAdminModal) showAdminModal(title, html);
  else if (window.showModal) showModal(title, html);
}
var _toast_fa28_fa43_fraud_control_center = function _toast(msg) { if (window.showToast) showToast(msg); }

...
// ✅ FIX (live-testing — likely a direct source of the /profileRequests
// permission_denied errors seen in testing): checkPending() queries
// `profileRequests` (Supabase-only) starting 2s after load, no bridge
// check at all. Wait for the actual Supabase bridge.
...
setInterval(_waitForBridgeThenCheckPending, 3*60*1000);
setTimeout(_waitForBridgeThenCheckPending, 2000);
